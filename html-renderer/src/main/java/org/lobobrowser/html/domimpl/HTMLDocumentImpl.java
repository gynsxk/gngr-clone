...
public class HTMLDocumentImpl extends NodeImpl implements HTMLDocument, DocumentView, DocumentStyle, EventTarget {
   ...
   *
   * @param locales
   *          An <i>immutable</i> set of <code>java.org.org.lobobrowser.util.Locale</code>
   *          instances.
   */
  ...
  public Object setUserData(final String key, final Object data, final UserDataHandler handler) {
    // if (org.org.lobobrowser.html.parser.HtmlParser.MODIFYING_KEY.equals(key) && data == Boolean.FALSE) {
    // dispatchLoadEvent();
    // }
  ...
  public void finishModifications() {
    ...
    /* Nodes.forEachNode(document, node -> {
      if (node instanceof NodeImpl) {
        ...
        Object oldData = element.getUserData(org.org.lobobrowser.html.parser.HtmlParser.MODIFYING_KEY);
        if (oldData == null || !oldData.equals(Boolean.FALSE)) {
          element.setUserData(org.org.lobobrowser.html.parser.HtmlParser.MODIFYING_KEY, Boolean.FALSE, null);
        }
      }
    });*/
  }
