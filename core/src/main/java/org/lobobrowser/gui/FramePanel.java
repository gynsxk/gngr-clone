...
public class FramePanel extends JPanel implements NavigatorFrame {
  ...
  */
  ...
  public final void navigate(final String urlOrPath) throws MalformedURLException {
    final URL url = DomainValidation.guessURL(urlOrPath);
    this.navigate(url, "GET", null, TargetType.SELF, RequestType.PROGRAMMATIC);
  }

  public final void navigate(final String urlOrPath, final RequestType requestType) throws MalformedURLException {
    final URL url = DomainValidation.guessURL(urlOrPath);
